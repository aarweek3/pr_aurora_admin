Понял. Вы хотите не просто создать с нуля, а перенести функционал и примеры из старого src\app\pages\ui-demo\input-ui в новый src\app\pages\ui-demo\input-control-aurora, но уже в формате "Gold Standard".

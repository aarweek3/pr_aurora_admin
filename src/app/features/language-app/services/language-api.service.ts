...
import { AppLanguage, AppStatus } from '../models/appLanguage.model';
...
export class LanguageApiService {
  ...
  /**
   * Получить статус готовности приложения
   */
  getAppStatus(): Observable<AppStatus> {
    return this.http.get<AppStatus>(ApiEndpoints.LANGUAGES_APP.APP_STATUS);
  }
}

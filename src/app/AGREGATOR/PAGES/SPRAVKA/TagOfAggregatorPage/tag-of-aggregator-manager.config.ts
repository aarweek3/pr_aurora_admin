...
export const DOCUMENTATION: ControlDocumentationConfig = {
  ...
  mainDescription: {
    ...
    detailedDescription: "Главный инструмент управления тегами. Поддерживает категории, типы тегов, SEO-параметры и наследование визуальных стилей от родительских категорий.",
    keyFeatures: [
    ...
    methods: [
      {
        ...
        returnType: "void",
        description: "Метод обновления списка с учетом текущих фильтров (slug, категория, корзина)."
      }
    ],
  },
  usageExamples: [
  ...
  architectureNotes: [
    {
      ...
      content: "Если перевод на текущий язык отсутствует, система автоматически подтягивает данные из en-US версии или Slug.",
    }
  ],
};

...
@Component({
  selector: 'app-license-type-of-aggregator-form',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    ...
    <nz-spin [nzSpinning]="loading">
      ...
      >
        <div nz-row [nzGutter]="[16, 16]">
          ...
          <div nz-col nzSpan="12">
            <nz-form-item>
              <nz-form-label nzRequired>Slug (Код для URL)</nz-form-label>
              <nz-form-control nzErrorTip="Введите slug">
                <input nz-input formControlName="slug" placeholder="Напр: free-license" />
              </nz-form-control>
            </nz-form-item>
          </div>
                    ...
                    @if (getLocGroup(lang.id); as locGroup) {
                      <div class="tab-content" [formGroup]="locGroup">
                        <div nz-row [nzGutter]="[16, 16]">
                          ...
                          <div nz-col nzSpan="24">
                            <nz-form-item>
                              <nz-form-label>Полное описание (HTML)</nz-form-label>
                              <nz-form-control>
                                <av-tinymce-control

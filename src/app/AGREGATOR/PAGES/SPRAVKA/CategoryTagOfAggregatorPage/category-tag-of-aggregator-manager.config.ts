...
export const DOCUMENTATION: ControlDocumentationConfig = {
  ...
  mainDescription: {
    ...
    detailedDescription:
      'Позволяет создавать, редактировать и настраивать визуальное отображение категорий тегов. Реализован на базе Angular Signals для максимальной производительности.',
    keyFeatures: [
  ...
  architectureNotes: [
    {
      ...
      content:
        "Теги могут наследовать цвет и иконку от категории, если в их настройках указано 'inherit'.",
    },
    {
      type: 'warning',
      title: 'Валидация удаления',
      content:
        'Система заблокирует удаление категории, если к ней привязан хотя бы один активный тег.',
    },
  ],
};

...
@Component({
  selector: 'app-category-tag-of-aggregator-manager',
  standalone: true,
  ...
  imports: [
    ...
    NzIconModule,
    NzToolTipModule,
    CategoryTagOfAggregatorListComponent,
    CategoryTagOfAggregatorModalComponent,
    CategoryTagOfAggregatorViewModalComponent,
  ...
  template: `
    <div class="page-container">
        ...
        <div class="header-main">
          <div class="title-section">
            <div class="title-with-settings">
              <h1>Категории тегов Агрегатора</h1>
              <button
                nz-button
                nzType="text"
                nzShape="circle"
            ...
            <p class="subtitle">
              Управление иерархией и группами тегов (Aurora v3.5 Reference)
      ...
      <div class="manager-content">
        <app-category-tag-of-aggregator-list
  ...
  `,
  styleUrls: ['./category-tag-of-aggregator-manager.component.scss'],
})
export class CategoryTagOfAggregatorManagerComponent implements OnInit {

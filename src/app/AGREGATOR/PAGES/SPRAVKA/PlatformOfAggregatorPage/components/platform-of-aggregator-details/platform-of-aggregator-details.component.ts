...
import { PlatformOfAggregatorDetailDto, PlatformOfAggregatorLocalizationDto } from '../../models/platform-of-aggregator.model';
...
@Component({
  ...
  styles: [`
    ...
    .platform-img { width: 32px; height: 32px; object-fit: contain; }

...
@Component({
      ...
      <div class="page-header">
        <div class="header-main">
          ...
          <div class="header-actions">
            <nz-radio-group [ngModel]="viewMode()" (ngModelChange)="viewMode.set($event)" nzButtonStyle="solid" class="view-mode-toggle">
  ...
  styles: [`
    ...
    .title-with-settings {
      ...
      align-items: center;
      gap: 12px;
      h1 { margin: 0; font-weight: 800; color: #1e293b; }
    }

    .subtitle {
      color: #64748b;
      margin-top: 4px;
      .count-badge { color: #1890ff; font-weight: 600; }
    }
    ...
    .sticky-status-bar {
      ...
      .status-item { font-size: 12px; color: #64748b; display: flex; align-items: center; gap: 6px; }
      .status-divider { width: 1px; height: 16px; background: #e2e8f0; }
      .version-tag { background: #f1f5f9; padding: 2px 8px; border-radius: 4px; font-weight: 600; }
    }
  `]
})

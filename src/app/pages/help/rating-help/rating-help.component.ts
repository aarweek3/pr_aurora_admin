...
@Component({
                ...
                <div class="controls-grid">
                  <div class="control-group">
                    ...
                    <div style="display: flex; gap: 12px; align-items: center;">
                       <nz-slider style="flex: 1" [nzMin]="0" [nzMax]="5" [nzStep]="0.1" [ngModel]="ratingValue()" (ngModelChange)="ratingValue.set($event)"></nz-slider>
                       <nz-input-number [ngModel]="ratingValue()" (ngModelChange)="ratingValue.set($event)" [nzMin]="0" [nzMax]="5" [nzStep]="0.1"></nz-input-number>
                    </div>
                  </div>

                  <div class="control-group">
                    <label>Размер (px):</label>
                    <nz-input-number [ngModel]="size()" (ngModelChange)="size.set($event)" [nzMin]="8" [nzMax]="120"></nz-input-number>
                  </div>
          ...
          <div class="api-section">
            ...
            <nz-card nzTitle="Технические особенности">
              <div class="tech-note">
                 ...
                 <p>В отличие от стандартных библиотек, которые используют "половинчатые" звезды, <code>av-rating</code> использует <strong>CSS Masking</strong> и <strong>Linear Gradients</strong>. Это позволяет:</p>
                 <ul>
            ...
            <nz-card nzTitle="Разные размеры и цвета">
               <div style="display: flex; flex-direction: column; gap: 24px;">
                  ...
                  <div class="case-item">
                     ...
                     <av-rating [value]="4.2" [size]="32" color="#52c41a" [showValue]="true"></av-rating>
                  </div>
               </div>
            </nz-card>
  ...
  styles: [`
    ...
    .control-group {
      ...
      flex-direction: column;
      gap: 8px;
      label { font-size: 12px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; }
    }
    ...
    .color-circle {
      ...
      transition: all 0.2s;
      &.active { transform: scale(1.2); outline: 2px solid #1890ff; }
    }
    ...
    .tech-note {
       ...
       padding: 20px;
       border-radius: 12px;
       h4 { color: #856404; margin-bottom: 12px; font-weight: 700; }
       p, li { color: #856404; font-size: 14px; }
    ...
    .case-label { font-weight: 600; color: #595959; }
...
export class RatingHelpComponent {
  ...
  inputs = [
    ...
    { name: 'showValue', type: 'boolean', default: 'false', desc: 'Отображать ли число рядом со звездами' },
    { name: 'total', type: 'number', default: '5', desc: 'Количество звезд (в текущей версии зафиксировано 5)' }
  ];

          ...
          <div class="tab-content">
            <nz-card nzTitle="Введение: Системные требования">
              <div class="logic-box bg-blue">
                <p>
                  <b>Что за задача?</b> Представь страницу программы VLC. Юзер хочет знать: «А
                  запустится ли это у меня?». Он должен увидеть: 🪟 Windows (от Win 7, x64), 🍎
                  macOS (от 10.13) и т.д.
                </p>
              </div>
              ...
              <div class="model-section" style="margin-top: 24px;">
                ...
                <p>
                  Можно было бы написать одно поле "Requirements" и вбить туда текст руками. Но это
                  <b>плохо</b>, потому что:
                </p>
                <ul>
                  <li>Нельзя отфильтровать программы "для Windows 7".</li>
                  <li>Нельзя автоматически подсветить нужную ОС пользователю.</li>
                  <li>
                    Разные редакторы напишут по-разному ("Win7", "Windows 7", "W7"), и будет каша.
                  </li>
                </ul>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <nz-timeline>
                  <nz-timeline-item nzColor="blue"
                    ><b>1. Бэкенд (C#):</b> Создать Enum архитектур, модели таблиц, добавить их в
                    DbContext и запустить миграцию.</nz-timeline-item
                  >
                  <nz-timeline-item nzColor="blue"
                    ><b>2. API:</b> Написать DTO и Контроллер (CRUD: получить, добавить, обновить,
                    удалить).</nz-timeline-item
                  >
                  <nz-timeline-item nzColor="green"
                    ><b>3. Фронтенд (Angular):</b> Добавить интерфейсы и создать UI-секцию в
                    карточке версии для управления требованиями.</nz-timeline-item
                  >
                </nz-timeline>
              </div>
            </nz-card>
            ...
            <nz-card nzTitle="Архитектурное решение: Enum vs Таблица в БД">
              <div class="logic-box bg-blue">
                <p>
                  <b>Вопрос от Junior:</b> Почему для архитектур процессоров (x64, Arm64) мы создаем
                  <code>Enum</code> в коде, а для версий ОС (Windows 10, 11) — целую таблицу в базе
                  данных?
                </p>
              </div>
              ...
              <div class="model-section" style="margin-top: 24px;">
                ...
                <p>
                  В таблице требований будет просто колонка <code>Architecture</code> с типом
                  <code>INT</code>. В ней лежат цифры: 0, 1, 2...
                </p>
                <ul>
                  <li><b>Это быстро:</b> Процессору легче сравнивать числа, чем строки.</li>
                  <li>
                    <b>Это компактно:</b> Одно число занимает в десятки раз меньше места, чем
                    название "Apple Silicon (Arm64)".
                  </li>
                </ul>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <p>
                  <b>Золотое правило:</b> Если данные не меняются годами — используй Enum. Если
                  данные добавляются часто — используй таблицу.
                </p>
                <ul>
                  <li>
                    <b>Архитектуры:</b> Новые типы процессоров появляются раз в 5-10 лет. Нам не
                    нужно давать админу возможность "создавать" новые архитектуры кнопкой.
                  </li>
                  <li>
                    <b>ОС:</b> Новые версии Windows, macOS и Android выходят каждый год. Мы хотим
                    добавлять их в справочник без пересборки всего бэкенда.
                  </li>
                </ul>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <p>
                  C# "из коробки" понимает, что цифра <code>2</code> — это <code>x64</code>. В коде
                  ты пишешь красиво:
                  <code>if (req.Architecture == RequirementArchitecture.x64)</code>, а не работаешь
                  с магическими числами или строками.
                </p>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <p>
                  В админке мы не заставляем пользователя вводить цифры. Мы создаем константу-массив
                  на фронтенде, которая мапит Enum на понятные названия. Пользователь видит "x64" в
                  выпадающем списке, а на бэкенд улетает цифра 2.
                </p>
              </div>
            ...
            <nz-card nzTitle="Шаг 1 — Что уже есть в системе?">
              ...
              <div class="model-section">
                ...
                <p>
                  Уже содержит: <code>1=Windows</code>, <code>2=macOS</code>,
                  <code>3=Android</code> и т.д.
                </p>
              </div>
              <div class="model-section" style="margin-top: 12px;">
                <h3>2. VersionsOfAggregator</h3>
                <p>
                  Это версии софта (например, VLC v3.0.20). Именно к ним мы и будем «подцеплять»
                  наши требования.
                </p>
              </div>
            </nz-card>
            ...
            <nz-card nzTitle="Механика справочника версий ОС (Lookup Table)">
              <div class="logic-box bg-dark">
                <p>
                  В отличие от архитектур, для ОС мы используем таблицу
                  <code>PlatformOsVersion</code>. Это позволяет динамически расширять список систем.
                </p>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <p>
                  В основной таблице требований мы не пишем текст "Windows 10", мы просто ставим
                  <b>ID</b> из таблицы выше:
                </p>
                <div class="logic-box">
                  <b>Requirement #100:</b> VLC 3.0.20 -> Platform: 1 (Win) -> MinOsVersionId:
                  <b>2</b> (ссылка на Windows 10)
                </div>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <ul>
                  <li>
                    <b>Порядок в данных:</b> Никаких опечаток вроде "Win10" или "Window 10". Строго
                    один вариант из списка.
                  </li>
                  <li>
                    <b>Умный выбор в админке:</b> Когда ты выбираешь платформу "Windows", система
                    подтянет только те версии, которые относятся к Windows.
                  </li>
                  <li>
                    <b>Легко обновлять:</b> Вышла Windows 12? Просто добавь одну строку в
                    справочник.
                  </li>
                </ul>
              </div>
            ...
            <nz-card nzTitle="🔗 Интеграция в Программу (Связи)">
              ...
              <div class="model-section" style="margin-top: 24px;">
                ...
                <p>
                  Системные требования не висят в воздухе. Они привязаны к конкретной
                  <b>Версии</b> программы:
                </p>
                <div class="tree-view">
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <ul>
                  <li>
                    <b>Гибкость:</b> У версии 1.0 могут быть одни требования, а у версии 2.0 (спустя
                    5 лет) — совсем другие.
                  </li>
                  <li>
                    <b>Множественность:</b> Одна версия программы может одновременно иметь
                    требования и для Windows, и для macOS, и для Linux.
                  </li>
                  <li>
                    <b>Простота запросов:</b> Чтобы узнать, пойдет ли программа у юзера, нам
                    достаточно загрузить список требований для выбранной версии.
                  </li>
                </ul>
              </div>
            ...
            <nz-card nzTitle="🌍 Шаг 3 — локализация (перевод доп. текста)">
              <p>
                К каждой строке требований можно добавить текст на разных языках — например,
                информацию о RAM или фреймворках.
              </p>
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>100</td>
                      <td>1 (EN)</td>
                      <td>Requires .NET 6, 4GB RAM</td>
                    </tr>
                    <tr>
                      <td>2</td>
                      <td>100</td>
                      <td>2 (RU)</td>
                      <td>Требуется .NET 6, 4 ГБ RAM</td>
                    </tr>
                  </tbody>
                </nz-table>
              </div>
            ...
            <nz-card nzTitle="💎 Что такое Architecture?">
              ...
              <ul>
                ...
                <li>
                  <b>Universal</b> — Сборки для macOS, работающие и на Intel, и на Apple Silicon.
                </li>
            ...
            <nz-card nzTitle="🖥️ Как это выглядит в админке (UI)?">
              <p>
                В карточке <b>Версии программы</b> появится новая секция «Системные требования»:
              </p>
              <div class="logic-box bg-blue">
          ...
          <div class="tab-content">
            <nz-card nzTitle="Новые сущности (DAL/Models/Aggregator)">
              ...
              <div class="model-section">
                ...
                <p class="desc">
                  Хранит список версий для каждой ОС (Windows 10, macOS Sonoma и т.д.).
                </p>
              ...
              <div class="model-section">
                ...
                <p class="desc">
                  Связывает версию программы с платформой, архитектурой и версией ОС.
                </p>
          ...
          <div class="tab-content">
            <nz-card nzTitle="Связи в текущих классах">
              ...
              <div class="logic-box bg-blue">
                ...
                <pre>
public virtual ICollection&lt;SystemRequirementOfAggregator&gt; SystemRequirements &#123; get; set; &#125;</pre
                >
              ...
              <div class="logic-box bg-blue" style="margin-top: 12px;">
                ...
                <pre>
public virtual ICollection&lt;PlatformOsVersionOfAggregator&gt; OsVersions &#123; get; set; &#125;</pre
                >
                <p>
                  <small>Платформа теперь содержит список своих версий (Win7, Win10...).</small>
                </p>
              </div>
              ...
              <div class="logic-box bg-dark">
                ...
                <pre>
public DbSet&lt;PlatformOsVersionOfAggregator&gt; PlatformOsVersions &#123; get; set; &#125;
        ...
        <nz-tab nzTitle="💡 4. Логика и Примеры">
          <div class="tab-content">
            <nz-card nzTitle="Как работает Min/Max OS Version?">
              <div class="logic-box">
                <p>
                  Мы используем логику <b>"От и До"</b>. В 99% случаев заполняется только
                  MinOsVersion.
                </p>
                <ul>
                  <li>
                    <b>Min: Windows 7, Max: NULL</b> — Работает на Win 7, 8, 10, 11 и всех будущих.
                  </li>
                  <li><b>Min: Windows 10, Max: Windows 11</b> — Работает только на 10 и 11.</li>
                </ul>
                <p>
                  Это избавляет от необходимости обновлять все программы при выходе новой Windows 12
                  — она автоматически попадет в диапазон "Windows 7+".
                </p>
              </div>
            </nz-card>
        ...
        <nz-tab nzTitle="🔍 5. Поиск и Сортировка">
          <div class="tab-content">
            <nz-card nzTitle="Универсальный компонент поиска (AvSearchComponent)">
              <p>
                В модуле используется <b>Universal Search Hero</b> — стандартизированный компонент
                Aurora из <code>&#64;shared/components/ui/search</code>.
              </p>

              <div class="logic-box bg-blue">
                <ul>
                  <li>
                    <b>Реактивный Debounce:</b> Автоматическая задержка в 300мс при наборе текста,
                    чтобы минимизировать нагрузку на БД.
                  </li>
                  <li>
                    <b>Two-way Signals:</b> Использование <code>model signal</code> для мгновенной
                    синхронизации строки поиска между компонентами.
                  </li>
                </ul>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <pre>
&lt;av-search [(value)]="searchTerm" (searchChange)="onSearchChange($event)"&gt;</pre
                >
                <ul style="margin-top: 8px;">
                  <li>
                    <b>Входные данные:</b> <code>avPlaceholder</code> (подсказка),
                    <code>avLoading</code> (индикация процесса).
                  </li>
                  <li>
                    <b>Событие onSearch:</b> Срабатывает автоматически после паузы или мгновенно при
                    нажатии Enter.
                  </li>
                </ul>
              </div>
            ...
            <nz-card nzTitle="Серверная фильтрация & Сортировка (Backend Pattern)">
              ...
              <div class="model-section">
                ...
                <ul>
                  <li>
                    <b>Поля:</b> <code>Name</code>, <code>SystemCode</code> и локализованные имена в
                    <code>Localizations</code>.
                  </li>
                  <li>
                    <b>Регистр:</b> Поиск регистронезависимый (используется <code>ToLower()</code>).
                  </li>
        ...
        <nz-tab nzTitle="📦 6. Начальные данные (JSON)">
          <div class="tab-content">
            <nz-card nzTitle="Файлы для сидирования (DAL/SeedData/Aggregator/)">
              <p>
                Для автоматического заполнения справочников при старте системы используем JSON
                файлы.
              </p>
              ...
              <div class="logic-box bg-blue" style="margin-top: 16px;">
                ...
                <code>PlatformId</code> по полю <code>platformCode</code>, чтобы правильно связать
                данные.
              </div>
            </nz-card>
          </div>
        ...
        <nz-tab nzTitle="🚀 7. План реализации">
          <div class="tab-content">
            <nz-card nzTitle="Как собрать модуль System Requirements с нуля? (Пошаговый план)">
              ...
              <div class="map-box">
                <h5 class="map-title">
                  <i nz-icon nzType="cluster"></i> Карта Бэкенд-модуля (DAL & API)
                </h5>
                <div class="map-grid">
              ...
              <div class="roadmap-container" style="margin-top: 32px;">
                ...
                <div class="roadmap-step">
                  <div class="step-header">
                    <nz-tag nzColor="blue">Step 1</nz-tag> <strong>Модели и БД</strong>
                  </div>
                  <div class="step-body">
                    <ul>
                      <li>Создать Entity и Localization в <code>DAL/Models/Aggregator</code>.</li>
                      <li>
                        Унаследовать Core от <code>FullAuditableEntityOfAggregator</code>, Loc от
                        <code>AuditableEntity</code>.
                      </li>
                      <li>
                        Добавить в <code>AppDbContext</code> и настроить связи в
                        <code>AggregatorModelConfiguration</code>.
                      </li>
                      <li>
                        Миграция:
                        <code>dotnet ef migrations add AddSystemRequirements --project DAL</code>.
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="roadmap-step">
                  <div class="step-header">
                    <nz-tag nzColor="blue">Step 2</nz-tag> <strong>Репозитории и UnitOfWork</strong>
                  </div>
                  <div class="step-body">
                    <ul>
                      <li>Реализовать <code>SystemRequirementRepository</code>.</li>
                      <li>
                        Добавить свойство в <code>IUnitOfWork.cs</code> и его реализацию в
                        <code>UnitOfWork.cs</code>.
                      </li>
                ...
                <div class="roadmap-step">
                  <div class="step-header">
                    ...
                    <strong>Логика и API (Контроллер)</strong>
                  </div>
                  <div class="step-body">
                    <ul>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> GetPaged с фильтром по PlatformId (для
                        ОС)
                      </li>
                      <li><nz-tag nzColor="success">OK</nz-tag> Логика проверки совместимости</li>
                      <li>
                        <nz-tag nzColor="processing">NEXT</nz-tag> Метод SeedOsVersionsAsync (48
                        версий ОС)
                      </li>
                      <li>
                        <nz-tag nzColor="processing">IN PROGRESS</nz-tag> Интеграция коллекции
                        требований в VersionOfAggregator
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="map-box" style="margin-top: 40px; border-color: #52c41a;">
                  <h5 class="map-title" style="color: #52c41a;">
                    <i nz-icon nzType="layout"></i> Карта Фронтенд-модуля (Angular v17+)
                  </h5>
                  <div class="tree-view">
                ...
                <div class="roadmap-step" style="margin-top: 32px;">
                  ...
                  <div class="step-body">
                    <ul>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> <b>API Service:</b> Реализовать методы
                        с использованием <code>HttpParams</code>.
                      </li>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> <b>State Service:</b> Внедрить SSOT на
                        базе <code>signal&lt;State&gt;</code>.
                      </li>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> Использовать
                        <code>executeWithLoading()</code> для всех асинхронных операций.
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="roadmap-step">
                  <div class="step-header">
                    ...
                    <strong>Функциональная спецификация UI</strong>
                  </div>
                  <div class="step-body">
                    <ul>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> <b>Поиск:</b>
                        <code>AvSearchComponent</code> (реактивный debounce 300мс).
                      </li>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> <b>Пагинация:</b>
                        <code>nz-pagination</code> (связка с pageIndex/pageSize в стейте).
                      </li>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> <b>Корзина:</b> Переключатель режима
                        отображения удаленных записей.
                      </li>
                      <li>
                        <nz-tag nzColor="success">OK</nz-tag> <b>Таблица:</b> Сортировка по клику на
                        заголовок (сброс на страницу 1).
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="roadmap-step">
                  <div class="step-header">
                    <nz-tag nzColor="green">Step 6</nz-tag>
                    <strong>Премиум Логика: Fallbacks</strong>
                  </div>
                  <div class="step-body">
                    <p>
                      <b>English Fallbacks:</b> Если при сохранении локализованное поле пустое —
                      автоматически копируется значение из en-US вкладки.
                    </p>
                  </div>
                </div>
            ...
            <nz-card nzTitle="Эталонная реализация (Sample)">
              ...
              <ul>
                ...
                <li>
                  Фронтенд State: <code>services/platform-of-aggregator-state.service.ts</code>
                </li>
              </ul>
            </nz-card>
          </div>
        ...
        <nz-tab nzTitle="✅ 8. Check Back">
          <div class="tab-content">
            <nz-card nzTitle="Backend Implementation Progress">
              <p>
                Отслеживание реализации серверной части System Requirements согласно утвержденному
                плану.
              </p>
              ...
              <div class="model-section">
                ...
                <ul>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Сущности PlatformOsVersion /
                    SystemRequirement сконфигурированы
                  </li>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Таблицы локализаций созданы в
                    <code>/Localizations</code>
                  </li>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <ul>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Репозитории для новых сущностей
                    реализованы
                  </li>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> UnitOfWork расширен новыми свойствами
                  </li>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <ul>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> GetPaged с фильтром по PlatformId (для ОС)
                  </li>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Логика проверки совместимости (Min/Max OS
                    Logic)
                  </li>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Метод <code>SeedOsVersionsAsync</code> (48
                    версий ОС)
                  </li>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Интеграция коллекции требований в
                    <code>VersionOfAggregator</code>
                  </li>
                </ul>
              </div>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <ul>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Контроллер
                    <code>OsVersionController</code> реализован
                  </li>
            ...
            <nz-card nzTitle="📝 Детальный лог действий (Activity Log)">
              <div class="logic-box bg-dark">
                <pre>
// --- Начало реализации System Requirements (v3.5) ---
[ПОДГОТОВКА]
        ...
        <nz-tab nzTitle="✅ 9. Check Front">
          <div class="tab-content">
            <nz-card nzTitle="Frontend Implementation Progress">
              <p>
                Отслеживание реализации клиентской части System Requirements согласно утвержденному
                плану.
              </p>
              1
              <div class="model-section">
                ...
                <ul>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> API Service реализован (v1 Integration)
                  </li>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> State Service (Signals SSOT) настроен
                  </li>
              ...
              <div class="model-section" style="margin-top: 16px;">
                ...
                <ul>
                  <li>
                    <nz-tag nzColor="success">OK</nz-tag> Роутинг в <code>aggregator-pages</code>
                  </li>
            ...
            <nz-card nzTitle="📝 Frontend Activity Log">
              <div class="logic-box bg-dark">
                <pre>
// --- Начало реализации Frontend (Angular v17+) ---
[ПОДГОТОВКА]

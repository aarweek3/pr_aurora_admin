      ...
      <div class="modal-body">
        ...
        >
          ...
          <div class="drop-content">
            ...
            <div class="drop-text"><strong>Выберите файл</strong> или перетащите его сюда</div>
        ...
        <div *ngIf="selectedFile()" class="editor-container">
          ...
          <div class="comparison-layout" [class.dual-view]="existingFile()">
            ...
            <div class="compare-card conflict" *ngIf="existingFile()">
              ...
              <div class="info-footer">
                <nz-tag nzColor="red"
                  >{{ existingFile()?.width }}x{{ existingFile()?.height }} px</nz-tag
                >
  ...
  styles: [
    `
      ...
      .modal-wrapper {
        ...
        background: white;
        border-radius: 24px;
        border: 1px solid rgba(148, 163, 184, 0.3) !important; // Sharp boundary contour
        box-shadow:
          0 25px 50px -12px rgba(15, 23, 42, 0.18), // Sleek depth elevation shadow
...
export class AvUniversalUploadModalComponent implements OnInit {
  ...
  readonly modalData =
    inject<AvUniversalUploadModalData>(MODAL_DATA, { optional: true }) ||
  ...
  private handleFile(file: File): void {
    ...
    const customName = this.modalData.fileName;
    if (customName) {
      const nameWithoutExt = customName.substring(0, customName.lastIndexOf('.')) || customName;
      this.targetFileName.set(this.imgService.slugify(nameWithoutExt));
    } else {
  ...
  private performActualUpload(file: File): void {
    ...
    this.imgService
      .upload(file, folder, finalName, this.width(), this.height())

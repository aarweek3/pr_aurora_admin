...
import { HelpUniversalModalComponent, HelpBlock } from '@shared/components/help-universal-modal/help-universal-modal.component';
...
@Component({
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <form nz-form nzLayout="vertical">
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                <nz-form-item>
                  ...
                  <nz-form-control>
                    <input nz-input [(ngModel)]="liveData.icon" name="icon" (ngModelChange)="updateJson()">
                  </nz-form-control>
                </nz-form-item>
                <nz-form-item>
                  <nz-form-label>Ширина</nz-form-label>
                  <nz-form-control>
                    <input nz-input [(ngModel)]="liveData.width" name="width" (ngModelChange)="updateJson()">
                  </nz-form-control>
                </nz-form-item>
              </div>
              ...
              <nz-form-item>
                ...
                <nz-form-control>
                  <input nz-input [(ngModel)]="liveData.title" name="title" (ngModelChange)="updateJson()">
                </nz-form-control>
              </nz-form-item>

              <button nz-button nzBlock nzType="primary" (click)="openLiveHelp()" style="height: 45px;">
          ...
          <nz-card nzTitle="Управление блоками (Быстрые действия)">
            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
              ...
              <button nz-button nzType="dashed" (click)="loadPreset('multi')">Пресет: Несколько разделов</button>
              <button nz-button nzType="dashed" (click)="loadPreset('legacy')">Пресет: Старый формат</button>
            </div>
          </nz-card>
        </div>
  ...
  styles: [`
    ...
    .json-highlight-layer, .json-textarea {
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
    ...
    :host ::ng-deep .json-key { color: #66d9ef; font-weight: 600; }
    :host ::ng-deep .json-string { color: #e6db74; }
    :host ::ng-deep .json-number { color: #ae81ff; }
  `]
})
export class TestHelpModalComponent {
  ...
  liveData: any = {
    ...
    componentPath: 'src/app/shared/components/test-components/test-help-modal/test-help-modal.component.ts',
    docPath: 'src/documentation/live-test.json'
  };

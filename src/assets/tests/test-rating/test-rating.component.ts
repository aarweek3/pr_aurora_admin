...
@Component({
  ...
  template: `
    <div style="padding: 24px; background: #f0f2f5; min-height: 100vh;">
      <nz-card nzTitle="🧪 Test Rating Control (AvRatingComponent)" style="max-width: 800px; margin: 0 auto;">
        
        <div style="margin-bottom: 32px; text-align: center;">
           <div style="font-size: 14px; color: #8c8c8c; margin-bottom: 8px;">Interactive Demo</div>
           <av-rating [value]="ratingValue()" [size]="48" [showValue]="true" [color]="currentColor"></av-rating>
           
           <div style="margin-top: 24px; max-width: 400px; margin-left: auto; margin-right: auto;">
             <nz-slider [nzMin]="0" [nzMax]="5" [nzStep]="0.1" [(ngModel)]="currentRating"></nz-slider>
             <nz-input-number [(ngModel)]="currentRating" [nzMin]="0" [nzMax]="5" [nzStep]="0.1"></nz-input-number>
           </div>

           <div style="margin-top: 16px; display: flex; justify-content: center; gap: 12px;">
             <div *ngFor="let c of ['#fadb14', '#ff4d4f', '#52c41a', '#1890ff', '#722ed1', '#eb2f96']"
                  [style.background]="c"
